...
VALUES 
  (@ProjectID, 'Planning & Research', 1, '2023-07-01', '2023-07-01'),
  (@ProjectID, 'Development', 2, '2023-07-01', '2023-07-01'),
  (@ProjectID, 'Testing & QA', 3, '2023-07-01', '2023-07-01'),
  (@ProjectID, 'Marketing & Launch', 4, '2023-07-01', '2023-07-01');
...
VALUES 
  (@Section1, 'Conduct Market Research', 'Analyze competitor products and user needs', 2, 1, '2023-07-06', '2023-07-01', '2023-07-01'),
  (@Section1, 'Define MVP Features', 'List essential features for first launch', 2, 2, '2023-07-11', '2023-07-01', '2023-07-01'),
  (@Section2, 'Design UI/UX', 'Create wireframes and mockups', 2, 1, '2023-07-16', '2023-07-01', '2023-07-01'),
  (@Section2, 'Develop Frontend', 'Implement UI components', 3, 2, '2023-07-21', '2023-07-01', '2023-07-01'),
  (@Section2, 'Develop Backend', 'Set up database and API', 3, 3, '2023-07-26', '2023-07-01', '2023-07-01'),
  (@Section3, 'Write Unit Tests', 'Ensure code quality with unit tests', 2, 1, '2023-07-31', '2023-07-01', '2023-07-01'),
  (@Section3, 'Perform User Testing', 'Get feedback from users', 2, 2, '2023-08-05', '2023-07-01', '2023-07-01'),
  (@Section3, 'Fix Bugs', 'Address major issues found in testing', 3, 3, '2023-08-10', '2023-07-01', '2023-07-01'),
  (@Section4, 'Create Marketing Plan', 'Define promotion strategy', 2, 1, '2023-08-15', '2023-07-01', '2023-07-01'),
  (@Section4, 'Prepare Launch Event', 'Organize live demo and Q&A', 3, 2, '2023-08-20', '2023-07-01', '2023-07-01'),
  (@Section4, 'Social Media Campaign', 'Promote via social platforms', 2, 3, '2023-08-25', '2023-07-01', '2023-07-01'),
  (@Section4, 'Launch Task App', 'Release product to public', 1, 4, '2023-08-30', '2023-07-01', '2023-07-01');
