...
public interface TeamsRepository extends JpaRepository<Teams, Long> {
    ...
    @Query(value = "SELECT " +
            ...
            "WHERE v.userID = ?1 AND t.dueDate IS NOT NULL AND t.dateCompleted IS NULL AND v.teamID = ?2", nativeQuery = true)
    List<Tasks> findTeamsDueTasks(Long userID, Long teamID);
